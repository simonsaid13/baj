...
export const SquaresFourIcon = ({ size = 28, color = Colors.black }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <Path d="M8.25 13.75H5.25C4.14543 13.75 3.25 14.6454 3.25 15.75V18.75C3.25 19.8546 4.14543 20.75 5.25 20.75H8.25C9.35457 20.75 10.25 19.8546 10.25 18.75V15.75C10.25 14.6454 9.35457 13.75 8.25 13.75Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M18.75 13.75H15.75C14.6454 13.75 13.75 14.6454 13.75 15.75V18.75C13.75 19.8546 14.6454 20.75 15.75 20.75H18.75C19.8546 20.75 20.75 19.8546 20.75 18.75V15.75C20.75 14.6454 19.8546 13.75 18.75 13.75Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);
...
export const HandshakeIcon = ({ size = 24, color = Colors.white }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <Path d="M20.25 12.5718L18.75 14.3343L15.3 17.7843C15.206 17.8722 15.092 17.936 14.968 17.9703C14.8439 18.0046 14.7133 18.0083 14.5875 17.9812L9.15 16.6218C9.05067 16.5941 8.95812 16.5462 8.87812 16.4812L3.75 12.478" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M18.7496 14.3345L14.6246 11.3345L13.4246 12.2345C12.9047 12.6225 12.2733 12.8321 11.6246 12.8321C10.9759 12.8321 10.3445 12.6225 9.82459 12.2345L9.31834 11.8501C9.23274 11.785 9.16193 11.7025 9.11061 11.608C9.05929 11.5135 9.02862 11.4092 9.02065 11.3019C9.01267 11.1947 9.02756 11.087 9.06434 10.9859C9.10111 10.8849 9.15893 10.7928 9.23397 10.7157L12.909 7.0501C12.978 6.98141 13.0599 6.927 13.15 6.89C13.2401 6.853 13.3366 6.83414 13.434 6.83448H17.2496" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M6.80664 6.73121L11.616 5.32496C11.7869 5.27595 11.9696 5.28924 12.1316 5.36246L15.3754 6.83433" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M10.5 19.9594L7.67813 19.2469C7.56313 19.2209 7.45666 19.166 7.36875 19.0875L5.25 17.25" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);
...
export const ChartBarIcon = ({ size = 24, color = Colors.white }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <Path d="M9.375 19.5V8.25H14.625" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M19.875 3.75H14.625V19.5H19.875V3.75Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);
...
export const ShoppingCartIcon = ({ size = 24, color = Colors.white }) => (
  <Svg width={size} height={size} viewBox="0 0 25 24" fill="none">
    ...
    <Path d="M4.21562 6.75H21.0344L18.5594 15.4125C18.4711 15.7269 18.282 16.0036 18.0211 16.2C17.7603 16.3965 17.4422 16.5019 17.1156 16.5H8.13437C7.80783 16.5019 7.4897 16.3965 7.22886 16.2C6.96803 16.0036 6.77893 15.7269 6.69062 15.4125L3.29688 3.54375C3.25203 3.38696 3.1573 3.24905 3.02704 3.15093C2.89677 3.05282 2.73808 2.99983 2.575 3H1" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);
...
export const ReceiptIcon = ({ size = 24, color = Colors.white }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <Path d="M3 19.5V5.25C3 5.05109 3.07902 4.86032 3.21967 4.71967C3.36032 4.57902 3.55109 4.5 3.75 4.5H20.25C20.4489 4.5 20.6397 4.57902 20.7803 4.71967C20.921 4.86032 21 5.05109 21 5.25V19.5L18 18L15 19.5L12 18L9 19.5L6 18L3 19.5Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);
...
export const CarIcon = ({ size = 24, color = Colors.white }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <Path d="M6.75 17.25V19.5C6.75 19.6989 6.67098 19.8897 6.53033 20.0303C6.38968 20.171 6.19891 20.25 6 20.25H3.75C3.55109 20.25 3.36032 20.171 3.21967 20.0303C3.07902 19.8897 3 19.6989 3 19.5V17.25" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M6 14.25H7.5" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M16.5 14.25H18" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M21 11.25L18.1969 4.95C18.1387 4.81672 18.043 4.70322 17.9215 4.62333C17.8 4.54343 17.6579 4.50058 17.5125 4.5H6.4875C6.34208 4.50058 6.19997 4.54343 6.07846 4.62333C5.95695 4.70322 5.86129 4.81672 5.80313 4.95L3 11.25V17.25H21V11.25Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);
...
export const StorefrontIcon = ({ size = 24, color = Colors.white }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <Path d="M9 9V10.5C9 11.2956 8.68393 12.0587 8.12132 12.6213C7.55871 13.1839 6.79565 13.5 6 13.5C5.20435 13.5 4.44129 13.1839 3.87868 12.6213C3.31607 12.0587 3 11.2956 3 10.5V9" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M15 9V10.5C15 11.2956 14.6839 12.0587 14.1213 12.6213C13.5587 13.1839 12.7956 13.5 12 13.5C11.2044 13.5 10.4413 13.1839 9.87868 12.6213C9.31607 12.0587 9 11.2956 9 10.5V9" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M21 9V10.5C21 11.2956 20.6839 12.0587 20.1213 12.6213C19.5587 13.1839 18.7956 13.5 18 13.5C17.2044 13.5 16.4413 13.1839 15.8787 12.6213C15.3161 12.0587 15 11.2956 15 10.5V9" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);
